...
public class PNChestBoat extends PNBoat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public PNChestBoat(EntityType<? extends PNChestBoat> type, Level level) {
        super(type, level);
    }

    public PNChestBoat(Level level, double x, double y, double z) {
        this(PNEntities.CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
